...
const RoleContext = reactExports.createContext({
...
function RoleProvider({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(RoleContext.Provider, { value: { role, setRole: handleSetRole }, children });
}
function useRole() {
  return reactExports.useContext(RoleContext);
}
const appCss = "/assets/styles-DbGdJ1xo.css";
...
function RootComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(RoleProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) });
}
const $$splitComponentImporter$7 = () => import("./dashboard-Cd7Rqr-z.js");
const Route$7 = createFileRoute("/dashboard")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Your AI strategic growth copilot for EdTech."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./index-B053dqu1.js");
const Route$6 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Autonomous real-time market intelligence for EdTech professionals. Powered by Google Gemini, 3 live news sources, and role-specific AI analysis."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./dashboard.index-D5_44K1q.js");
const Route$5 = createFileRoute("/dashboard/")({
  head: () => ({
    meta: [{
      title: "Overview — Campus Cortex AI"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./dashboard.trends-QbTUBQiY.js");
const Route$4 = createFileRoute("/dashboard/trends")({
  head: () => ({
    meta: [{
      title: "Trend Forecast — Campus Cortex AI"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./dashboard.settings-DvRZGFsy.js");
const Route$3 = createFileRoute("/dashboard/settings")({
  head: () => ({
    meta: [{
      title: "Settings — Campus Cortex AI"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./dashboard.reports-BF6k5I-A.js");
const Route$2 = createFileRoute("/dashboard/reports")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./dashboard.recommendations-Cv_c3uon.js");
const Route$1 = createFileRoute("/dashboard/recommendations")({
  head: () => ({
    meta: [{
      title: "AI Recommendations — Campus Cortex AI"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./dashboard.competitors-To6D4qd1.js");
const Route2 = createFileRoute("/dashboard/competitors")({
  head: () => ({
    meta: [{
      title: "Competitor Radar — Campus Cortex AI"
    }]
  }),
...
const DashboardTrendsRoute = Route$4.update({
  id: "/trends",
  path: "/trends",
  getParentRoute: () => DashboardRoute
});
...
const DashboardRecommendationsRoute = Route$1.update({
  id: "/recommendations",
  path: "/recommendations",
  getParentRoute: () => DashboardRoute
});
const DashboardCompetitorsRoute = Route2.update({
  id: "/competitors",
  path: "/competitors",
  getParentRoute: () => DashboardRoute
});
const DashboardRouteChildren = {
  DashboardCompetitorsRoute,
  DashboardRecommendationsRoute,
